...
export const metadata = {
  ...
  description:
    "Servicios profesionales de outsourcing contable, revisoría fiscal, auditoría, asesoría aduanera y consultoría tributaria en Medellín.",
  keywords:
    "servicios contables Medellín, outsourcing contable, revisoría fiscal, auditoría financiera, asesoría aduanera, consultoría tributaria",
};
          ...
          <div className="container">
            <div className={styles.heroContent}>
              ...
              <p className={styles.heroSubtitle}>
                Soluciones integrales y personalizadas para el crecimiento y
                cumplimiento de tu empresa en Medellín
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container">
            <div className="text-center">
              ...
              <p className={styles.sectionSubtitle}>
                Más de 20 años de experiencia respaldan nuestra calidad y
                compromiso
              </p>
            </div>
              ...
              {servicios.map((servicio, index) => (
                ...
                >
                  ...
                  <div className={styles.serviceBody}>
                    <p className={styles.serviceFullDesc}>
                      {servicio.fullDesc}
                    </p>
          ...
          <div className="container">
            <div className={styles.specialContent}>
              ...
              <p className={styles.specialDescription}>
                También ofrecemos servicios especializados según tus necesidades
                específicas
              </p>
              ...
              <div className={styles.specialGrid}>
                <div className={styles.specialItem}>
                  ...
                  <p>
                    Acompañamiento en apertura y estructuración contable inicial
                  </p>
                </div>
                ...
                <div className={styles.specialItem}>
                  ...
                  <p>
                    Servicios personalizados según requerimientos especiales
                  </p>
                </div>
              </div>
            </div>
