...
const getAuthorName = (author: string) => {
  const authorMap: Record<string, { name: string; role: string }> = {
    "Néstor Ramírez": {
      name: "Néstor Ramírez",
      role: "Gerente - Especialista en Outsourcing Contable",
    },
    "María Fernanda Callejas": {
      name: "María Fernanda Callejas",
      role: "Auditora y Revisora Fiscal",
    },
    "Paula Montoya": {
      name: "Paula Montoya",
      role: "Coordinadora de Contabilidad",
    },
    "Viviana Vargas": {
      name: "Viviana Vargas",
      role: "Coordinadora Administrativa y Gestión Humana",
    },
  };
  ...
  return (
    authorMap[author] || {
      name: author,
      role: "Experto en Contabilidad y Finanzas",
    }
  );
};
            ...
            <div className={styles.heroContent}>
              <div className={styles.heroMeta}>
                ...
                <span className={styles.fecha}>
                  {formatDate(articulo.date)}
                </span>
                <span className={styles.tiempoLectura}>
                  {articulo.readTime} lectura
                </span>
              </div>
                ...
                <div className={styles.authorInfo}>
                  ...
                  <div>
                    <p className={styles.authorName}>
                      {getAuthorName(articulo.author).name}
                    </p>
                    <p className={styles.authorRole}>
                      {getAuthorName(articulo.author).role}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <aside className={styles.sidebar}>
                <div className={`card ${styles.sidebarCard}`}>
                  ...
                  <div className={styles.authorBio}>
                    ...
                    <div>
                      <h4>Ramírez Asesores SAS</h4>
                      <p>
                        Firma contable con más de 20 años de experiencia en
                        Medellín, especializada en outsourcing contable,
                        revisoría fiscal, auditoría y consultoría tributaria.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="container">
            <div className={styles.ctaContent}>
              <h2 className={styles.ctaTitle}>
                ¿Necesitas asesoría personalizada sobre{" "}
                {articulo.category.toLowerCase()}?
              </h2>
              <p className={styles.ctaSubtitle}>
                Nuestros expertos están listos para ayudarte con soluciones
