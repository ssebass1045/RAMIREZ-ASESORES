              ...
              <ScrollReveal animation="fade-up">
                <div className="text-center">
                  ...
                  <p className={styles.sectionSubtitle}>
                    Soluciones integrales para el crecimiento y cumplimiento de
                    tu empresa
                  </p>
                </div>
              </ScrollReveal>
              ...
              <div className={styles.allServicesGrid}>
                {services.map((service, index) => (
                  <ScrollReveal
                    ...
                    delay={index * 100}
                  >
                    <div className={`card ${styles.serviceCard} hover-lift`}>
              ...
              <div className={styles.whyUsContent}>
                <ScrollReveal animation="fade-right">
                  <div className={styles.whyUsText}>
                    <h2 className={styles.sectionTitle}>
                      ¿Por qué elegir{" "}
                      <span className={styles.highlight}>Ramírez Asesores</span>
                      ?
                    </h2>
                    <p className={styles.whyUsDescription}>
                      Más de 20 años de experiencia nos respaldan. Somos tu
                      aliado estratégico en el crecimiento empresarial con
                      servicios de alta calidad y compromiso.
                    </p>
                      ...
                      {[
                        {
                          ...
                          desc: "Profesionales especializados en cada área de servicio",
                        },
                        {
                          title: "Tecnología y Procesos Optimizados",
                          desc: "Utilizamos las mejores herramientas para eficiencia y precisión",
                        },
                        {
                          title: "Enfoque en Medellín y Antioquia",
                          desc: "Conocemos el mercado local y sus particularidades",
                        },
                        {
                          title: "Resultados Comprobados",
                          desc: "98% de cumplimiento en entregas y satisfacción del cliente",
                        },
                      ].map((benefit, i) => (
                        <ScrollReveal
                          key={i}
              ...
              <div className={styles.testimonialsGrid}>
                {[
                  ...
                  },
                  {
                    ...
                    text: "La firma Ramírez Asesores es una empresa seria, responsable, con la que llevo más de 20 años donde he sentido el respeto y compromiso para el cliente.",
                    rating: 5,
                  },
                  {
                    logo: "/reseña/cliente5.jpeg",
                    name: "Impocarga",
                    text: "Ramírez Asesores, es la firma más confiable en asesorías contables, tributarias y legales, son claros y precisos en los procesos, esto gracias a la experiencia, conocimiento y trabajo en equipo.",
                    rating: 5,
                  },
                  {
                    logo: "/reseña/cliente6.jpeg",
                    name: "Futuro Eléctrico",
                    text: "Gracias a su acompañamiento nos han ayudado a organizar nuestras finanzas y a cumplir con las obligaciones tributarias, son muy responsables y claros. Siempre están atentos a resolver nuestras dudas y son muy profesionales.",
                    rating: 5,
                  },
                ].map((testimonial, i) => (
            ...
            <div className="container">
              <ScrollReveal animation="fade-up">
                <div className="text-center">
                  <h2 className={styles.sectionTitle}>
                    Preguntas{" "}
                    <span className={styles.highlight}>Frecuentes</span>
                  </h2>
                  <p className={styles.sectionSubtitle}>
              ...
              <div className={styles.faqGrid}>
                {[
                  {
                    q: "¿Qué es el outsourcing contable?",
                    a: "Es la externalización de la gestión contable de tu empresa a un equipo de expertos, permitiéndote enfocarte en el crecimiento del negocio mientras garantizamos el cumplimiento normativo.",
                  },
                  {
                    q: "¿Cuándo es obligatoria la revisoría fiscal?",
                    a: "Es obligatoria para sociedades por acciones cuando sus activos brutos superan los 5.000 salarios mínimos legales mensuales vigentes.",
                  },
                  {
                    q: "¿Qué ventajas tiene contratar sus servicios?",
                    a: "Ahorro de costos, acceso a equipo experto, reducción de riesgos tributarios, información contable precisa y cumplimiento normativo garantizado.",
                  },
                  {
                    q: "¿Trabajan con empresas de todos los tamaños?",
                    a: "Sí, atendemos desde emprendimientos hasta grandes corporaciones, adaptando nuestros servicios a las necesidades específicas de cada cliente.",
                  },
                ].map((faq, i) => (
            ...
            <div className="container">
              <ScrollReveal animation="fade-up">
                <div className="text-center">
                  ...
                  <p className={styles.sectionSubtitle}>
                    Artículos y guías sobre contabilidad, finanzas y
                    normatividad para tu empresa
                  </p>
                </div>
              </ScrollReveal>
